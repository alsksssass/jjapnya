...
class Log(commands.Cog):
    ...
    @commands.hybrid_command(name='로그', with_app_command=True, description="엑셀로 저장된 로그를 불러옵니다.모두누름가능")
    @commands.guild_only()
...
async def setup(bot):
    await bot.add_cog(Log(bot), guilds=None)  # Add guild IDs if needed
